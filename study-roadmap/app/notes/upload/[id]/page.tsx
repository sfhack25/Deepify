...
export default function UploadNotes({
  ...
  const topicId = typeof searchParams?.topicId === "string" ? searchParams.topicId : "1"
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Save the fact that notes have been uploaded for this topic
    try {
      // Get existing notes data or initialize new object
      ...
      // For now, just redirect to the post-lecture quiz
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex items-center">
          ...
          <h1 className="text-3xl font-bold text-foreground">Upload Post-Lecture Notes</h1>
        </div>
        <ThemeToggle />
      </div>
